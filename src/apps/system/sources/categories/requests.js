...
const debug = Debug('apps:system:sources:categories_requests')

const SECOND = 1000
const MINUTE = 60 * SECOND

const system_categories_paths = {
...
export { periodical, once, system_categories_paths }
