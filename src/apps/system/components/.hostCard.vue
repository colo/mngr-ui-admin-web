  ...
  data () {
    return {
      ...
      grid: {
        layouts: {
          'lg': [
            { x: 0, y: 0, w: 12, h: 4, i: 'loadavg', immobile: true }
            // { x: 0, y: 1, w: 12, h: 2, i: 'separator' }
          ],
          'md': [
            { x: 0, y: 0, w: 8, h: 4, i: 'loadavg', immobile: true }
            // { x: 0, y: 1, w: 8, h: 2, i: 'separator' }
          ],
          'sm': [
            { x: 0, y: 0, w: 6, h: 4, i: 'loadavg', immobile: true }
      ...
      components: {
        'loadavg': [
          {
            component: chartTabular,
            props: {
              wrapper: {
                type: 'vueEasyPieChart',
              },
              always_update: false,
              // ref: this.host + '.loadavg',
              // id: this.host + '.loadavg',
              stat: {
                // data: [[
                //   this.host_data['os.loadavg']['1_min'],
                //   (100 * this.host_data['os.loadavg']['1_min'] / this.host_data['os.loadavg.max']) || 0,
                //   this.host_data['os.loadavg.max'] || 0
                // ]],
                length: 1
              },
              chart: {
    ...
    host_data: function (val) {
      this.$set(this.components.loadavg, 0, Object.merge(this.components.loadavg[0], {
        props: {
          ...
          stat: {
            data: [[
              val['os.loadavg']['1_min'],
              (100 * val['os.loadavg']['1_min'] / val['os.loadavg.max']) || 0,
              val['os.loadavg.max'] || 0
            ]],
            length: 1
          },
        }
      ...
      debug('watch host_data', val, this.components)
    }
  },
  methods: {
