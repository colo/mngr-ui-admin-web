...
const debug = Debug('apps:system:components:hostCard:netOut')
...
export default {
  ...
  computed: {
    ...
    barColor: function () {
      return dbColors.getColors(this.$store.state.layout.dark, this.$store.state.layout.dashboardColorScheme)[2]
    }
  },
