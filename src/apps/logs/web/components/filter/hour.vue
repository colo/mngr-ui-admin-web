<template>
  <div>
    ...
    <component
      ...
      :always_update="false"
      :ref="'hour.top_country_counter'"
      :id="'hour.top_country_counter'"
      :key="$route.path +'.'+ JSON.stringify($route.query)+'.hour.top_country_counter'"
      :stat="{
        data: [
          hour.top_country_counter
        ],
        length: 1,
        numeric: false
      }"
