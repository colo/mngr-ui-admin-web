<template>
  <div>
    ...
    <component
      ...
      :always_update="false"
      :ref="'minute.top_country_counter'"
      :id="'minute.top_country_counter'"
      :key="$route.path +'.'+ JSON.stringify($route.query)+'.minute.top_country_counter'"
      :stat="{
        data: [
          minute.top_country_counter
        ],
        length: 1,
        numeric: false
      }"
