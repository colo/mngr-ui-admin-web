<template>
  <chart-tabular
    ...
    :always_update="false"
    :ref="type+'.world_map_countries'"
    :id="type+'.world_map_countries'"
    :stat="{
      data: [
        world_map_countries
      ],
...
const debug = Debug('apps:logs:web:components:worldcountriesMap')
...
export default {
  ...
  name: 'LogsWebWorldcountriesMap',

  data () {
    return {
      id: 'logs.web.world.countries.map',
