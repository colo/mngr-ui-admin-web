      ...
      grid: {
        layouts: {
          'lg': [
            ...
            { x: 0, y: 0, w: 3, h: 8, i: 'messagesBars', immobile: false },
            ...
            { x: 12, y: 0, w: 3, h: 4, i: 'topHostDeliveriesMini', immobile: false },
            { x: 12, y: 4, w: 3, h: 4, i: 'topHostMsgMini', immobile: false },

            { x: 15, y: 0, w: 3, h: 8, i: 'domainFromPie', immobile: false },
            { x: 18, y: 0, w: 3, h: 8, i: 'domainToPie', immobile: false },
          ...
          'md': [
            { x: 0, y: 0, w: 4, h: 8, i: 'messagesBars', immobile: false },
            ...
            { x: 0, y: 8, w: 4, h: 4, i: 'topHostDeliveriesMini', immobile: false },
            { x: 4, y: 8, w: 4, h: 4, i: 'topHostMsgMini', immobile: false },
            { x: 8, y: 8, w: 4, h: 4, i: 'validMini', immobile: false },
            { x: 12, y: 8, w: 4, h: 4, i: 'failedMini', immobile: false },

            { x: 0, y: 12, w: 4, h: 8, i: 'domainFromPie', immobile: false },
            { x: 4, y: 12, w: 4, h: 8, i: 'domainToPie', immobile: false },
          ...
          'sm': [
            ...
            { x: 0, y: 8, w: 3, h: 4, i: 'topHostDeliveriesMini', immobile: false },
            { x: 3, y: 8, w: 3, h: 4, i: 'topHostMsgMini', immobile: false },
            { x: 6, y: 8, w: 3, h: 4, i: 'validMini', immobile: false },
            { x: 9, y: 8, w: 3, h: 4, i: 'failedMini', immobile: false },

            { x: 0, y: 12, w: 6, h: 8, i: 'domainFromPie', immobile: false },
            { x: 6, y: 12, w: 6, h: 8, i: 'domainToPie', immobile: false },
          ...
          'xs': [
            ...
            { x: 6, y: 8, w: 3, h: 4, i: 'topHostDeliveriesMini', immobile: false },

            { x: 0, y: 12, w: 3, h: 4, i: 'topHostMsgMini', immobile: false },
            { x: 3, y: 12, w: 3, h: 4, i: 'validMini', immobile: false },
            { x: 6, y: 12, w: 3, h: 4, i: 'failedMini', immobile: false },

            { x: 0, y: 16, w: 4, h: 8, i: 'domainFromPie', immobile: false },
            { x: 5, y: 16, w: 4, h: 8, i: 'domainToPie', immobile: false },
          ...
          'xxs': [
            ...
            { x: 0, y: 16, w: 3, h: 4, i: 'topHostDeliveriesMini', immobile: false },
            { x: 3, y: 16, w: 3, h: 4, i: 'topHostMsgMini', immobile: false },

            { x: 0, y: 20, w: 3, h: 8, i: 'domainFromPie', immobile: false },
            { x: 3, y: 20, w: 3, h: 8, i: 'domainToPie', immobile: false },
    ...
    values: {
      handler: function (values) {
        ...
        if (values && Object.getLength(values) > 0) {
          ...
          //
          this.$set(this.components.messagesBars[0].props, 'value', {
            value: values.messages,
            title: values.messages + ' - ' + this.format_timestmap_standar(values.timestamp)
          })

          if (values.bytes && values.bytes >= 0) {
            let info = 'Bytes'
            let unit = 'bytes'
            let divider = 1
            ...
            this.$set(this.components.bytesBars[0].props, 'info_value', (values.bytes / divider).toFixed(0))
            this.$set(this.components.bytesBars[0].props, 'value', {
              value: values.bytes,
              title: (values.bytes / divider).toFixed(0) + unit + ' - ' + this.format_timestmap_standar(values.timestamp)
            })
          }
          //
          ...
          if (values.top_deliveries_host) {
            this.$set(this.components.topHostDeliveriesMini[0].props, 'info', 'Top host deliveries: ' + values.top_deliveries_host.host)
            this.$set(this.components.topHostDeliveriesMini[0].props, 'value', values.top_deliveries_host.value)
          }

          if (values.top_msg_host) {
            this.$set(this.components.topHostMsgMini[0].props, 'info', 'Top host msgs: ' + values.top_msg_host.host)
            this.$set(this.components.topHostMsgMini[0].props, 'value', values.top_msg_host.value)
          }
          //
          ...
          //   })
          //
          //   this.$set(this.components.domainFromPie[0].props, 'info', info)
          //   this.$set(this.components.domainFromPie[0].props, 'info_value', _top_os)
          //   // this.$set(this.components.domainFromPie[0].props, 'value', {labels: labels, datasets: datasets})
          //   this.$set(this.components.domainFromPie[0].props, 'value', dataset)
          // }
          //
          if (values.domain_from_counter) {
            let info = ''
            let _top_domain = 0
            let total = 0
            // let labels = []
            ...
            // let datasets = [{ data: []}]
            let dataset = []
            Object.each(values.domain_from_counter, function (value, domain) {
              if (value > _top_domain) {
                _top_domain = value
                info = domain
              }
              dataset.push({
            ...
            this.$set(this.components.domainFromPie[0].props, 'info', 'From: ' + info)
            this.$set(this.components.domainFromPie[0].props, 'info_value', _top_domain)
            // this.$set(this.components.domainFromPie[0].props, 'value', {labels: labels, datasets: datasets})
            this.$set(this.components.domainFromPie[0].props, 'value', dataset)
          }
          if (values.domain_to_counter) {
            let info = ''
            let _top_domain = 0
            let total = 0
            // let labels = []
            ...
            // let datasets = [{ data: []}]
            let dataset = []
            Object.each(values.domain_to_counter, function (value, domain) {
              if (value > _top_domain) {
                _top_domain = value
                info = domain
              }
            ...
            this.$set(this.components.domainToPie[0].props, 'info', 'To: ' + info)
            this.$set(this.components.domainToPie[0].props, 'info_value', _top_domain)
            // this.$set(this.components.domainToPie[0].props, 'value', {labels: labels, datasets: datasets})
            this.$set(this.components.domainToPie[0].props, 'value', dataset)
          }
          //
          ...
          //   })
          // }
          this.$set(this.components.validMini[0].props, 'value', values.success_delivery)
          this.$set(this.components.failedMini[0].props, 'value', values.failed_delivery)
        }
      },
      deep: true
    }
