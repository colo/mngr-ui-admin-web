    ...
    <div class="q-pa-md">
      <div class="bg-primary text-white">
        ...
        <q-toolbar>
          ...
          <q-btn flat class="q-mr-xs" label="Hosts" :to="{name : 'os_hosts'}"/>
          <q-btn flat class="q-mr-xs" label="Categories" :to="{name : 'os_categories'}"/>
...
import * as PeriodicalSources from '@apps/os/sources/hosts/periodical/index'
import * as MinuteSources from '@apps/os/sources/hosts/minute/index'
